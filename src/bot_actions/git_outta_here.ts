 ...
 */
export const GitOuttaHere = {
  botActionName: "GitOuttaHere",
  badNote:
  ...
  hashtag: `[#GitOuttaHere](https://github.com/Cigna/GitRDoneBot#7-git-outta-here)`,
   ...
   */
  async analyze(api: MergeRequestApi): Promise<BotActionResponse> {
    let action:
      | AuthorizationFailureBotAction
      | NetworkFailureBotAction
      | SuccessfulBotAction
