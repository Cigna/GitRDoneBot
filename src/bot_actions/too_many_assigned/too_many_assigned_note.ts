...
export class TooManyAssignedNote extends BotActionNote {
  static readonly bad = `:loudspeaker: You've assigned this merge request to someone who already has a lot on their plate. Reassigning the merge request to someone else will help it get approved more quickly`;
