...
export class TooManyAssignedNote extends BotActionNote {
  ...
  static readonly hashtag = `[#TooManyAssignedAnalysis](https://github.com/Cigna/GitRDoneBot#too-many-assigned-analysis)`;
  ...
  static customCaseForCheckPermissionsMessage(
    ...
    return (
      state !== "merge" && gitLabRequestSuccess === false && assigneeId !== null
    );
  }
